...
export const SECTOR_IMAGES = [tech_logo, health_logo, energy_logo, banking_logo];
...
export const USER_FORM_AGE_HOVERTEXT = "A higher age will yield a less risky Pie."
export const USER_FORM_RISK_HOVERTEXT = "A higher value will yield a riskier Pie."
export const USER_FORM_SECTOR_HOVERTEXT = "The Pie will focus on companies from this sector."
